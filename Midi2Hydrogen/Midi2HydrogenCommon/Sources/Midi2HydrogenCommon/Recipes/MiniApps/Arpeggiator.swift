...
struct ArpeggiatorView: View {
    ...
    var body: some View {
        ...
        HStack {
            Midi2HydrogenKnob(text: "BPM", parameter: $conductor.tempo, range: 20.0...250.0)
            Midi2HydrogenKnob(text: "Length", parameter: $conductor.noteLength, range: 0.0...1.0)
        }
        Midi2HydrogenKeyboard(noteOn: conductor.noteOn,
                         noteOff: conductor.noteOff)
        .midi2HydrogenNavBarTitle("Arpeggiator")
        .onAppear {
            conductor.start()
        }
        .onDisappear {
