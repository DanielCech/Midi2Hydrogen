...
struct MusicToyView: View {
    ...
    var body: some View {
        VStack {
            ...
            HStack {
                Midi2HydrogenKnob(text: "Tempo",
                             parameter: $conductor.data.tempo,
                             range: 20 ... 300).padding(5)
                Midi2HydrogenKnob(text: "Filter Frequency",
            ...
            HStack {
                Midi2HydrogenKnob(text: "Drums Volume",
                             parameter: $conductor.data.drumVolume,
                             range: 0.5 ... 1).padding(5)
                Midi2HydrogenKnob(text: "Arpeggio Volume",
                             parameter: $conductor.data.arpeggioVolume,
                             range: 0.5 ... 1).padding(5)
                Midi2HydrogenKnob(text: "Chords Volume",
                             parameter: $conductor.data.padVolume,
                             range: 0.5 ... 1).padding(5)
                Midi2HydrogenKnob(text: "Bass Volume",
                             parameter: $conductor.data.bassVolume,
                             range: 0.5 ... 1).padding(5)
            }
        }
        .padding()
        .midi2HydrogenNavBarTitle("Music Toy")
        .onAppear {
            conductor.start()
        }
        .onDisappear {
