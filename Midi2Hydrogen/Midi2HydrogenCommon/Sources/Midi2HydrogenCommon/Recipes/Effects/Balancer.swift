...
struct BalancerView: View {
    ...
    var body: some View {
        VStack {
            ...
            HStack {
                Midi2HydrogenKnob(text: "Rate", parameter: $conductor.rate, range: 0.3125 ... 5)
                Midi2HydrogenKnob(text: "Frequency", parameter: $conductor.frequency, range: 220 ... 880)
        ...
        .padding()
        .midi2HydrogenNavBarTitle("Balancer")
        .onAppear {
            conductor.start()
        }
        .onDisappear {
